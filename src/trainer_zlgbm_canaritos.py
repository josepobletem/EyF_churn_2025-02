...
def run_zlgbm_pipeline(config_path: str = "config/config.yaml") -> Dict[str, Any]:
    ...
    kaggle_path = os.path.join(
        zcfg.kaggle_dir,
        f"KA_{zcfg.experimento}_{top_n}_202105_minleaf50_5can_5seed_22month_gb01_prestamosless_driff1_0203less_final_julio_semillero.csv"
    )
    ...
    pred_detallado_path = os.path.join(
        zcfg.pred_dir,
        f"pred_zlgbm_{zcfg.experimento}_202105_minleaf50_5can_5seed_22month_gb01_prestamosless_driff1_0203less_final_julio_semillero.csv"
    )
